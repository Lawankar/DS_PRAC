...
public class Server {
    public static void main(String args[]) {
        ...
        Server server = new Server(port);// calling constructructor of server final and initialisig in
                                         // object(server) of serverfina;
    ...
    public void startServer() // starting the server
    {
        ...
        while (true) {
            try {
                clientSocket = echoServer.accept();// clientsocket is intialised
                numConnections++;// number of connectections is increament
                Server2Connection oneconnection = new Server2Connection(clientSocket, numConnections, this);// caling
                                                                                                            // constructor
                                                                                                            // of
                                                                                                            // server2
                                                                                                            // funcction
